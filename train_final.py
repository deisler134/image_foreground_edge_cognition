...
from utils import alpha_prediction_loss, get_available_cpus, get_available_gpus, overall_loss
...
if __name__ == '__main__':
    ...
    pretrained_path = 'models/refinement.86-0.0360.hdf5'            #args["pretrained"]
...
#     final.compile(optimizer=sgd, loss=alpha_prediction_loss, target_tensors=[decoder_target])
    final.compile(optimizer=sgd, loss=overall_loss, target_tensors=[decoder_target])
